...
/**
 * @title RedDragonLPBooster
 * @dev Contract that provides probability boosts for LP token holders in the lottery
 */
contract RedDragonLPBooster is Ownable {
    // LP token used for determining boost eligibility
    IERC20 public lpToken;
    
    // RedDragonSwapLottery contract reference
    RedDragonSwapLottery public lottery;
    
    // Boost parameters (configurable by owner)
    uint256 public boostPercentage = 69; // 0.69% boost by default
    uint256 public boostPrecision = 10000; // For 0.01% precision
