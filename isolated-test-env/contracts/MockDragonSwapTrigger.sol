...
import "./IDragonSwapTrigger.sol";

/**
 * @title MockDragonSwapTrigger
 * @dev Mock implementation of Dragon Swap Trigger for testing
 */
contract MockDragonSwapTrigger is IDragonSwapTrigger, Ownable, ReentrancyGuard {
    // State variables
    ...
    /**
     * @notice Process randomness via original interface
    ...
    function fulfillRandomness(uint256 _requestId, uint256 _randomness) external override {
        ...
        revert("Use processRandomness instead");
    }
