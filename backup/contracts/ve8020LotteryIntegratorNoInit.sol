...
/**
 * @title ve8020LotteryIntegratorNoInit
 * @dev Standalone version of the ve8020LotteryIntegrator that doesn't call _setLotteryVotingToken in constructor
 * This integrator can be manually connected to the lottery after deployment
 */
contract ve8020LotteryIntegratorNoInit is Ownable {
    // Contracts
    ...
    /**
     * @dev Constructor that doesn't call _setLotteryVotingToken
    ...
    constructor(address _veToken, address _lottery) {
        ...
        // Intentionally skipping the _setLotteryVotingToken call
    }
