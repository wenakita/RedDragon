...
import "../DragonLPBooster.sol";

/**
 * @title MockDragonLotteryWithBoost
 * @dev Simplified version of lottery with boost integration for testing
 */
contract MockDragonLotteryWithBoost is Ownable, ReentrancyGuard {
    ...
    DragonLPBooster public lpBooster;
    ...
    function setBooster(address _booster) external onlyOwner {
        ...
        lpBooster = DragonLPBooster(_booster);
